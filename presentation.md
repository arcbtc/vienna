---
marp: true
title: "The Age of Corporate Nihilism"
description: "How FLOSS, Bitcoin, Nostr, and AI can defend low-time-preference capitalism"
theme: default
class: invert
paginate: true
style: |
  section {
    ...
    --red: #ff6f61;
    background:
      radial-gradient(circle at 88% 14%, rgba(84, 214, 214, 0.16), transparent 28%),
      linear-gradient(135deg, #090b0f 0%, #11151d 55%, #16100d 100%);
    color: var(--ink);
  ...
  li::before {
    ...
    height: 2px;
    background: var(--gold);
    box-shadow: 7px 0 0 rgba(84, 214, 214, 0.85);
  }
  ...
  section.title {
    ...
    background:
      radial-gradient(circle at 50% 28%, rgba(244, 185, 66, 0.18), transparent 30%),
      radial-gradient(circle at 78% 76%, rgba(84, 214, 214, 0.16), transparent 28%),
      linear-gradient(135deg, #050609 0%, #11151d 52%, #1d1309 100%);
  }
  ...
  section[data-marpit-advanced-background="content"] {
    background:
      linear-gradient(90deg, rgba(9, 11, 15, 0.98), rgba(9, 11, 15, 0.9));
  }
...
# Capital in Context
![bg right:40%](images/adam_smith.png)
...
![bg right:40%](images/stallman.png)
